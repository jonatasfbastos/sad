 ...
 */
@Component
public class TelaExibirAluno extends javax.swing.JFrame {
    ...
    @Autowired
    private TelaEdicaoAluno telaEdicao;

    private List<Aluno> alunos;

    /**
     * Creates new form TelaExibirAluno
     */
    ...
    public void atualizarTabela() {
        try {
            this.alunos = this.facade.getAllAluno();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        // Tentando encontrar aluno pelo ID
        try {
            Aluno aluno = this.facade.findByIdAluno(id);

            // Mensagem de confirmação
            if (JOptionPane.showConfirmDialog(null, "Deseja realmente deletar "
                    + aluno.getNome() + "?", "Deletar Dados", JOptionPane.DEFAULT_OPTION) == 0) {
                this.facade.deleteAluno(aluno);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            Aluno aluno = this.facade.findByIdAluno(id);
            this.telaEdicao.setAluno(aluno);
    ...
    private void txtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyPressed
        ...
        if (this.alunos == null || this.alunos.isEmpty()) {
            try {
                this.alunos = this.facade.findByNomeAluno(nome);
            } catch (Exception error) {
                JOptionPane.showMessageDialog(null, error,
        ...
        for (Aluno aluno : alunos) {
            if (aluno.getNome().toLowerCase().contains(nome)) {
                tabelaDados.addRow(new Object[]{
                    aluno.getId(),
                    aluno.getNome(),
                    aluno.getUsuario().getLogin(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExibirAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExibirAluno().setVisible(true);
            }
        });
    }
