 ...
 */
@Component
public class TelaExibirModalidade extends javax.swing.JFrame {
    @Autowired
    ...
    private void initComponents() {
        ...
        txtBuscar.setText("Buscar Modalidade");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExibirModalidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExibirModalidade().setVisible(true);
            }
        });
    }
